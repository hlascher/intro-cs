...
void draw() {
  ...
  tower(600, 500, 200, "kitty", color(124, 166, 233));
    tower(500, 400, 100, "person", color(124, 166, 233));
    tower(700, 400, 100, "kitty", color(124, 166, 233));
       tower(900, 400, 100, "person", color(124, 166, 233));
        tower(100, 300, 200, "kitty", color(222, 135, 12));
         tower(1100, 300, 200, "person", color(222, 135, 12));
                  tower(1100, 500, 200, "kitty", color(222, 135, 12));
                     tower(1300, 500, 200, "person", color(222, 135, 12));
}
